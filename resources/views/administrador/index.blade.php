...
@section('content')
    ...
    @endif
    <a class="btn-round add new-btn-success" href="{{ url('/admin/administrador/create') }}">
        <i class="fa fa-fw fa-plus">Adicionar</i>
    </a>
    <div class="col-md-12">
    	<table class="table">
                    <thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-round btn-link"  href="{{ url('admin/administrador/' . $us->id.'/edit')}}">
                                    <i class="glyphicon glyphicon-pencil"></i>
                                </a>
                                <form action="{{ url('admin/administrador/' . $us->id)}}" method="POST" style="display: inline-block;">
                                    {{ method_field('delete') }}
                                    {!! csrf_field() !!}
